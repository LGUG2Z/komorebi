...
pub enum SocketMessage {
    ...
    InitialWorkspaceRuleRegex(ApplicationIdentifier, String, usize, usize),
    InitialNamedWorkspaceRuleRegex(ApplicationIdentifier, String, String),
    WorkspaceRuleRegex(ApplicationIdentifier, String, usize, usize),
    NamedWorkspaceRuleRegex(ApplicationIdentifier, String, String),
