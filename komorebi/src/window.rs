...
#[derive(Copy, Clone, Debug, Display, EnumString, Serialize, Deserialize, JsonSchema, PartialEq)]
#[serde(untagged)]
...
#[derive(Copy, Clone, Debug, Default, Display, EnumString, Serialize, Deserialize, JsonSchema, PartialEq)]
