...
pub struct BatteryConfig {
    ...
    /// Select when the current percentage is under this value [[1.0-100.0]]
    pub auto_select_under: Option<f32>,
}
...
impl From<BatteryConfig> for Battery {
    fn from(value: BatteryConfig) -> Self {
        ...
        Self {
            ...
            auto_select_under: value.auto_select_under.map(|u| u.clamp(1.0, 100.0)),
