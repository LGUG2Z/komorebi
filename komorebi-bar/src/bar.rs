...
impl Komobar {
    ...
    pub fn new(
        ...
        if let Some(mouse) = &komobar.config.mouse {
            komobar.input_config.act_on_vertical_scroll =
                mouse.on_scroll_up.is_some() || mouse.on_scroll_down.is_some();
            komobar.input_config.act_on_horizontal_scroll =
                mouse.on_scroll_left.is_some() || mouse.on_scroll_right.is_some();
            komobar.input_config.vertical_scroll_threshold = mouse
                .vertical_scroll_threshold
                .unwrap_or(30.0)
                .clamp(10.0, 300.0);
            komobar.input_config.horizontal_scroll_threshold = mouse
                .horizontal_scroll_threshold
                .unwrap_or(30.0)
                .clamp(10.0, 300.0);
            // limit how many "ticks" can be accumulated
            komobar.input_config.vertical_scroll_max_threshold =
                komobar.input_config.vertical_scroll_threshold * 3.0;
            komobar.input_config.horizontal_scroll_max_threshold =
                komobar.input_config.horizontal_scroll_threshold * 3.0;
        }
